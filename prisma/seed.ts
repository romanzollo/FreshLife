...
async function main() {
    ...
    await prisma.product.createMany({
        data: [
            {
                name: 'Яблоки Голден',
                description: 'Свежие яблоки, 1 кг',
                price: 129,
            ...
            {
                name: 'Бананы',
                description: 'Спелые бананы, связка',
                price: 89,
                categoryId: catMap['fruits-vegetables'],
                inStock: 80,
                unit: 'кг',
            ...
            {
                name: 'Молоко 3.2%',
                description: 'Молоко пастеризованное, 1 л',
                price: 95,
            ...
            {
                name: 'Кефир 2.5%',
                description: 'Кефир натуральный, 1 л',
                price: 78,
                categoryId: catMap['dairy'],
                inStock: 60,
                unit: 'л',
            ...
            },
            {
                ...
                description: 'Говядина для тушения, 500 г',
                price: 299,
                categoryId: catMap['meat-poultry'],
                inStock: 25,
                unit: 'кг',
                imageUrl: '/products/beef.jpg',
            },
            {
                name: 'Сок апельсиновый',
                description: 'Сок прямого отжима, 1 л',
                price: 159,
            ...
            },
            {
                ...
                description: 'Вода газированная, 1.5 л',
                price: 45,
                categoryId: catMap['beverages'],
                inStock: 150,
                unit: 'шт',
            ...
            {
                name: 'Хлеб белый',
                description: 'Хлеб нарезной, 400 г',
                price: 55,
            ...
            },
            {
                ...
                description: 'Булочки свежие, 4 шт',
                price: 89,
                categoryId: catMap['bakery'],
                inStock: 35,
                unit: 'шт',
                imageUrl: '/products/buns.jpg',
            },
            {
                name: 'Помидоры',
                description: 'Томаты свежие, 1 кг',
                price: 199,
                categoryId: catMap['fruits-vegetables'],
                inStock: 45,
                unit: 'кг',
            ...
            {
                name: 'Огурцы',
                description: 'Огурцы грунтовые, 1 кг',
                price: 149,
                categoryId: catMap['fruits-vegetables'],
                inStock: 55,
                unit: 'кг',
            ...
            },
            {
                ...
                description: 'Йогурт без добавок, 125 г',
                price: 49,
                categoryId: catMap['dairy'],
                inStock: 90,
                unit: 'шт',
