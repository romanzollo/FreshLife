  ...
  return (
    <div className="animate-fade-in min-h-screen">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {/*
          Кнопка "Добавить товар" использует брендовый Indigo-600.
          При hover — Indigo-700 (темнее). Disabled — приглушённый серый.
        */}
        <button
          onClick={handleAdd}
          disabled={loading}
          className="px-5 py-2.5 text-white rounded-xl font-medium transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          style={{
